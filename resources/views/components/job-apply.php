					...
					<div class="bi-team-details-contact-form">
						<form action="#" method="get">
							<div class="row">
								...
								<div class="col-md-6">
									<input type="text" name="name" placeholder="Location (City)">
								</div>
								<div class="col-md-6">
									<input type="text" name="name" placeholder="Position">
								</div>
								<div class="col-md-6">
									<input type="text" name="email" placeholder="Portfolio / Website link..">
								</div>
								<div class="col-md-6">
									<input type="text" name="name" placeholder="Your expected salary">
								</div>
								<div class="col-md-12">
