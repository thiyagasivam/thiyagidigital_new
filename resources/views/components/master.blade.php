						...
						<nav class="mobile-main-navigation  clearfix ul-li">
							<ul id="m-main-nav" class="nav navbar-nav clearfix">
                                ...
                                <li class="dropdown">
									...
									<ul class="dropdown-menu clearfix">
										<li><a href="service.php" target="_blank">Brand & Art</a></li>
                                        <li><a href="service.php" target="_blank">Digital Marketing</a></li>
                                        <li><a href="service.php" target="_blank">Web Development</a></li>
                                        <li><a href="service.php" target="_blank">Design & Development</a></li>
                                        <li><a href="service.php" target="_blank">3D Animation</a></li>
                                        <li><a href="service.php" target="_blank">Branding & Ilastration</a></li>
									</ul>
								</li>
						...
						<div class="content-inner">
							...
							<div class="sidebar-menu ul-li-block">
								<ul>
									...
									<li><a href="service.php"><i class="fal fa-cogs"></i> Service </a></li>
									<li><a href="testimonila.php"><i class="fal fa-comments-alt"></i> Testimonial </a></li>
									<li><a href="team.php"><i class="fal fa-users"></i> Our Team </a></li>
									<li><a href="portfolio.php"><i class="fal fa-briefcase"></i> Portfolio </a></li>
									<li><a href="blog.php"><i class="fal fa-blog"></i> Blog </a></li>
									<li><a href="contact.php"><i class="fal fa-envelope"></i> Contact </a></li>
								</ul>
							</div>
							...
							<div class="sidebar-social ul-li-block">
								...
								<ul>
                                    ...
                                    <li> <a href="#"> <i class="fab fa-youtube"></i>Youtupe</a></li>
                                ...
                                <div class="hpt-hero-2-slider-item">
                                    ...
                                    <div class="container h1-container">
                                        ...
                                        <div class="hpt-hero-2-slider-content">
                                            ...
                                            <!-- <p class="hero-2-pera" data-animation="fadeInUp" data-duration="1s" data-delay=".8s">ThiyagiDigital offers Digital Marketing services of all sizes a chance to promote business & branding. As long We have a best digital presence, our clients will always discover new stratagies from us.</p> -->
                ...
                <div class="container h1-container z-index-3">
                    ...
                    <div class="htp-project-count-2-wrap">
                        <div class="hpt-project-count-1-wrap">
                            ...
                            <!-- single-item -->
                            <div class="hpt-project-count-1-item ">
                                <h3 class="title" ><span class="counter">140</span></h3>
                                <span class="text" >Happy Customers</span>
                            </div> 

                            <!-- single-item -->
                            <div class="hpt-project-count-1-item ">
                                <h3 class="title" ><span class="counter" >255</span>+</h3>
                                <span class="text" >Happy Customers</span>
                            </div> 
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="hpt-footer-widget headline pera-content ul-li-block">
                                    <div class="about-widget">
                                        ...
                                        <p>
                                            We offer full-cycle technology solutions that streamline your digital transformation journey. With cutting-edge technical expertise, ThiyagiDigital. simplifies complex business challenges with innovative solutions for 50+ fastest-growing enterprises.
                                        </p>
                                    </div>
                                </div>
                            </div>
